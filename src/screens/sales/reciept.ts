...
<div class="container box-shadow">
    ...
    <div class="heading">
        ...
        <div class="invoice-number">
            <p>${invoiceNumber}</p>
            <p class="invoice-amharic">የደረሰኝ ቁጥር</p>
        </div>
    </div>

    <div class="qrCode">
        ${QRCodeGenerator(dataQr)}
    </div>
    <div class="center">
      <div class="card-info">
          <p>ደንበኛ: </p>
    ...
    <div class="items padding box-shadow border-radius">
        ...
        <div class="item">
            <div class="item-left">
                <p>ስም - ${items[i].itemName}</p>
                <p>ብዛት - ${items[i].quantity}</p>
            </div>
            <p class="item-right">የአንዱ ዋጋ - ${items[i].unitPrice} ብር</p>
        </div>`;
          })
          .join('')}
